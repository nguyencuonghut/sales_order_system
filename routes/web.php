...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'orders'], function () {
        Route::get('/orderdata', 'OrdersController@orderData')->name('orders.orderdata');
        Route::get('/productdata', 'OrdersController@productData')->name('orders.productdata');
    });
    ...
    Route::post('carts/{id}/store',
        ['as' => 'carts.store', 'uses' => 'CartsController@store']);
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::post('/doImport', 'UsersController@doImport')->name('users.doimport');
    });
